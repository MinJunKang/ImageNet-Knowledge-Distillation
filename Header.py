...
def Set_Parameter(args):
    ...
    parser.add_argument('--max_overfit',type=int,default=10)
    ...
    parser.add_argument('--max_learning_rate',type=float,default=0.00001)

    # Set batch size
    parser.add_argument('--min_batch', type=int, default=64)
    ...
    if(args.model_usage == "teacher"):
        ...
        # Model information
        parser.add_argument('--input_shape',type=list,default=[299,299,3])
        parser.add_argument('--output_shape',type=list,default=[1001])
        ...
        # DNN Node Setting
        parser.add_argument('--min_node',type=int,default=256)
        ...
        parser.add_argument('--max_layer',type=int,default = 10)
